...
function removeFlavorByName(arr, flavorStr){
    arr.splice(arr.indexOf(flavorStr), 1);
    return arr;
}
...
let newList = [];
newList = copy(newList, originalFlavors) ;
console.log(newList)
...
var regionalFlavors = ["Pink Bubblegum",
    ...
    "Caramel 'n' Cookies"]
// I attempted this stretch but couldn't figure it out

// function getRandomFlavors(arr1, arr2, arr3, arr4){
//     let totalArr = arr1.concat(arr2,arr3,arr4);
//     let newFlavorsArr = []
//     for(let counter = 0; counter < 32; counter++){
//         let randomItem = totalArr[Math.floor(Math.random() * totalArr.length)];
//         console.log(counter);
//         console.log(randomItem[counter]);
//         newFlavorsArr.push(randomItem);
